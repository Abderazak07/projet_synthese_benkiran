...
import { MapPin, CreditCard, ShoppingBag, Loader2, ShieldCheck, ArrowRight, ArrowLeft } from 'lucide-react';
            ...
            <div className="border-2 border-black p-8">
              ...
              <div className="space-y-4">
                ...
                <textarea
                  required
                  rows={3}
                  className="w-full bg-adi-silver border-2 border-adi-silver focus:border-black p-4 text-black font-bold text-sm outline-none transition-all resize-none"
