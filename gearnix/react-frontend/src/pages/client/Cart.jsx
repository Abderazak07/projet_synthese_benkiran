...
import { X, Trash2, ShoppingCart, ArrowRight, Minus, Plus, ShoppingBag, Truck, Info, RotateCcw } from 'lucide-react';
          ...
          <div className="lg:col-span-8 flex flex-col">
            ...
            <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-4">
               ...
               <div className="bg-adi-silver p-6 flex flex-col gap-2">
                  ...
                  <p className="text-[10px] font-bold text-adi-gray leading-tight">RETOURNEZ VOS ARTICLES FACILEMENT ET GRATUITEMENT DANS UN DÉLAI DE 30 JOURS.</p>
               </div>
            </div>
          </div>
