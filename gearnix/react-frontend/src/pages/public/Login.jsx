    ...
    <div className="min-h-screen bg-white font-sans text-black pt-20">
      ...
      <div className="adi-login-container animate-in fade-in slide-in-from-bottom-4 duration-700">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button type="button" className="text-[11px] font-black uppercase underline tracking-widest hover:bg-black hover:text-white px-1 transition-all">
            Mot de passe oublié ?
          </button>
