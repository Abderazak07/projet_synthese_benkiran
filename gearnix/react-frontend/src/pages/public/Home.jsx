...
export default function Home() {
  ...
  return (
    <div className="bg-white min-h-screen text-black font-sans selection:bg-black selection:text-white">
      ...
      <section className="relative w-full h-screen overflow-hidden bg-adi-silver">
        <img 
          src="https://images.unsplash.com/photo-1588423770574-910ae26c85e7?q=80&w=2560" 
          alt="Audio Gear" 
        ...
        <div className="relative z-10 h-full adi-container flex flex-col justify-end pb-32">
          <div className="max-w-3xl text-white">
            <h1 className="text-5xl md:text-6xl font-black italic tracking-tighter leading-[0.9] mb-8 animate-in slide-in-from-left duration-700">
              LE SON SANS <br /> CONCESSION
            </h1>
            <p className="text-xl md:text-2xl font-bold uppercase tracking-tight mb-10 max-w-xl animate-in slide-in-from-left duration-1000">
              AirPods, Coques iPhone & Casques Bluetooth Premium. <br /> Le meilleur de la tech, livré chez vous.
            </p>
      ...
      <section className="py-20 md:py-32">
        <div className="adi-container">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
            <div>
              <h2 className="text-5xl font-black italic tracking-tighter mb-2">DERNIERS ARRIVAGES</h2>
              <p className="text-sm font-bold text-adi-gray uppercase tracking-widest italic">LES MEILLEURES PROTECTIONS & AUDIO CHEZ GEARNIX</p>
            </div>
        ...
        <div className="adi-container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
            ...
            <div className="group relative aspect-[16/9] overflow-hidden bg-black">
              <img src="https://images.unsplash.com/photo-1505740420928-5e560c06d30e?q=80&w=1200" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700 opacity-80" alt="" />
              <div className="absolute inset-x-10 bottom-10">
                <h3 className="text-4xl font-black text-white italic uppercase tracking-tighter mb-4">IMMERSION SONORE</h3>
                <Link to="/produits" className="adi-btn adi-btn-white py-3 px-8 text-xs">VOIR LES CASQUES</Link>
              </div>
            </div>

            {/* Massive Promo 2 */}
            <div className="group relative aspect-[16/9] overflow-hidden bg-black">
              <img src="https://images.unsplash.com/photo-1603302576837-37561b2e2302?q=80&w=1200" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700 opacity-80" alt="" />
              <div className="absolute inset-x-10 bottom-10">
                <h3 className="text-4xl font-black text-white italic uppercase tracking-tighter mb-4">PROTECTION PREMIUM</h3>
                <Link to="/produits" className="adi-btn adi-btn-white py-3 px-8 text-xs">COQUES IPHONE</Link>
              </div>
            </div>
      ...
      <section className="py-32">
        <div className="adi-container grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          <div className="lg:col-span-7 relative aspect-video group overflow-hidden">
             <img src="https://images.unsplash.com/photo-1585565804112-f201f68c48b4?q=80&w=1500" className="w-full h-full object-cover grayscale brightness-50 group-hover:scale-105 transition-transform duration-1000" alt="" />
          ...
          <div className="lg:col-span-5">
             ...
             <h2 className="text-6xl font-black italic tracking-tighter uppercase leading-[0.9] mb-8">PASSION <br /> TECH</h2>
             <p className="text-lg font-bold text-black/70 mb-10 leading-snug">
               Depuis notre création, Gearnix s'est donné pour mission d'équiper les utilisateurs exigeants avec les meilleurs accessoires pour leurs appareils préférés. Performance, style et protection.
             </p>
      ...
      <section className="bg-black py-20 text-white text-center">
        <div className="adi-container max-w-4xl">
           <h2 className="text-5xl font-black italic tracking-tighter mb-6 uppercase">PARTAGEZ VOTRE STYLE #GEARNIX</h2>
           <p className="text-lg font-bold text-white/60 mb-12 italic uppercase tracking-widest">POSTEZ VOTRE SETUP SUR INSTAGRAM POUR TENTER DE GAGNER UN PACK ACCESSOIRES TOUS LES MOIS.</p>
