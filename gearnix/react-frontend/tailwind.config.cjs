...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        'lux-hero': "radial-gradient(1200px 600px at 65% 40%, rgba(14,165,233,0.12), transparent 55%), radial-gradient(900px 500px at 25% 20%, rgba(124,58,237,0.20), transparent 55%), linear-gradient(180deg, rgba(7,7,9,0.0) 0%, rgba(7,7,9,0.70) 55%, rgba(7,7,9,1.0) 100%)",
      ...
      boxShadow: {
        ...
        'glow-gold': '0 0 0 1px rgba(14,165,233,0.22), 0 18px 60px rgba(0,0,0,0.60)',
